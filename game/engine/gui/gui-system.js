...
export default class GuiSystem extends System {
    ...
    checkUIHover() {
      ...
      this.workForTag('GuiCanvasRenderable', (renderable, entity) => {
        ...
        let isHovered = isPointInRotatedRect(cursorCoordinates.canvas.xPosition, cursorCoordinates.canvas.yPosition, xPosition, yPosition, width, height, angleDegrees, false)
    ...
    checkUIClick(payload) {
      ...
      if (payload.type == 'click') {
        ...
        this.workForTag('GuiCanvasRenderable', (renderable, entity) => {
          ...
          let wasSelected = isPointInRotatedRect(payload.canvas.xPosition, payload.canvas.yPosition, xPosition, yPosition, width, height, angleDegrees, false)
